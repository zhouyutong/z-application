...
import static com.zhouyutong.zapplication.id.Assertions.isTrueArgument;
import static com.zhouyutong.zapplication.id.Assertions.notNull;
...
public final class DistributedId implements Comparable<DistributedId>, Serializable {
    ...
    public static String get(String prefix) {
        ...
        return prefix + new DistributedId().toString();
    }
     ...
     * @param date the date
     */
    public DistributedId(final Date date) {
     ...
     */
    public DistributedId(final Date date, final int counter) {
     ...
     */
    public DistributedId(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public DistributedId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     */
    public DistributedId(final String hexString) {
     ...
     */
    public DistributedId(final byte[] bytes) {
     ...
     */
    DistributedId(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
     ...
     * @since 3.4
     */
    public DistributedId(final ByteBuffer buffer) {
